...
var table = new Tabulator("#classes-in-event", {
    ...
    data:[
        {id: "1", class: "無初級成年女子", gender: "女", grade: "無初級", number: "4", grouping: "4", group_number: "1", type: "JSF0", warm_up_time: "4", off_ice_time: "2", total_time: "3", start_time: "8:00", end_time: "9:00"},
        {id: "2", class: "", gender: "", grade: "", number: "", grouping: "", group_number: "", type: "", warm_up_time: "", off_ice_time: "", total_time: "", start_time: "", end_time},
    ],
});